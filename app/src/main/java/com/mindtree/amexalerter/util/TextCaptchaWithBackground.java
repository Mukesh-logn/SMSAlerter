...
public class TextCaptchaWithBackground extends Captcha {
    ...
    public TextCaptchaWithBackground(int wordLength, TextOptions opt) {
        new TextCaptchaWithBackground(0, 0, wordLength, opt);
    }

    public TextCaptchaWithBackground(int width, int height, int wordLength, TextOptions opt) {
        setHeight(height);
        setWidth(width);
        this.options = opt;
